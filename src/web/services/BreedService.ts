import { url_breed_list_all, url_image_fetch_prefix, dogceo_resp_status_success } from "../constants";
...
export class BreedService {
  ...
  async listAll(): Promise<BreedJSON[]> {
    return this.restfulCall(url_breed_list_all, BreedService.parseBreedList.bind(this));
  }
  ...
  static generateImageURL(breed: BreedJSON): string {
    return `${url_image_fetch_prefix}/${breed.breed}${breed.subbreed?('/'+breed.subbreed):''}/images`;
  }
